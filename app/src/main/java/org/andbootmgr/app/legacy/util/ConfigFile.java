...
public class ConfigFile {
    ...
    public void exportToPrivFile(String tempfilename, String fullPath) {
        exportToFile(new File("/data/data/org.andbootmgr.app/files/" + tempfilename));
        SuFile.open("/data/data/org.andbootmgr.app/files/" + tempfilename).renameTo(new File(fullPath));
    }
