package org.andbootmgr.app.legacy.ui.updatelk;
        ...
        if (requestCode == 5207) {
            if (resultCode == Activity.RESULT_OK) {
                ...
                try {
                    ...
                    @SuppressLint("SdCardPath") File targetFile = new File("/data/data/org.andbootmgr.app/files/lk2nd.img");
                    OutputStream outStream = new FileOutputStream(targetFile);
                    assert initialStream != null;
                    SplashActivity.copyFile(initialStream, outStream);
                    initialStream.close();
                    outStream.close();
                    Shell.sh("file /data/data/org.andbootmgr.app/files/lk2nd.img").submit((out) -> {
