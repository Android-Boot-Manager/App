package org.andbootmgr.app.legacy.ui.activities;
...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean mount(DeviceModel d) {
        if (SuFile.open("/data/abm/bootset/db").exists())
            return true;
        Shell.Result result;
        if(!(result = Shell.su("/data/data/org.andbootmgr.app/assets/Scripts/config/mount/" + d.codename + ".sh").exec()).isSuccess()) {
    ...
    public boolean umount(DeviceModel d) {
        ...
        if(!(result = Shell.su("/data/data/org.andbootmgr.app/assets/Scripts/config/umount/" + d.codename + ".sh").exec()).isSuccess()) {
            Log.e("ABM_MOUNT",String.join("",result.getOut()));
            Log.e("ABM_MOUNT",String.join("",result.getErr()));
            return false;
        }
